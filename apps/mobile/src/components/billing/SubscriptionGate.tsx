...
function billingUrl(): string {
  const base = webBaseUrl() || 'https://dogvantage.se'
  return `${base}/profile?section=billing`
}
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top + space.xxl, paddingBottom: insets.bottom + space.xxl }]}>
      ...
      <Text style={styles.body}>
        DogVantage-konton hanteras på dogvantage.se. Öppna sidan för att se ditt konto.
      </Text>
      <Pressable
        style={styles.cta}
        onPress={() => void WebBrowser.openBrowserAsync(billingUrl())}
        accessibilityRole="link"
      >
        <Text style={styles.ctaText}>Öppna dogvantage.se</Text>
      </Pressable>
