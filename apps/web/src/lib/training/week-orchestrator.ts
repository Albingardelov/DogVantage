...
import { currentIsoWeek, type WeeklyFocusArea } from '@dogvantage/core'
...
import { computeProgressionDecisions, formatProgressionRule, type ProgressionMetricRow } from '@dogvantage/core'
import { computeHandlerStruggle, dampAdvances, type HandlerStruggle } from '@dogvantage/core'
import { getDogState, updateThresholdAdjustments } from '@/lib/supabase/dog-state'
import { evaluateDecisions, computeThresholdAdjustments } from '@dogvantage/core'
import {
  getPendingDecisions,
...
import { TRAINING_PROTOCOLS, toProjectInput, type ActiveProjectInput } from '@dogvantage/core'
import { getHomecomeWeekPlan } from '@dogvantage/core'
