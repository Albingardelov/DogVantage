...
import type { Breed, TrainingGoal, TrainingEnvironment, RewardPreference, Exercise, DailyExerciseMetrics, HouseholdPet } from '@dogvantage/core'
import { getExerciseSpec } from '@dogvantage/core'
import { resolveLiveCoach } from '@/lib/training/live-coach'
import { getLifeStage, isPuppy as isPuppyAge } from '@dogvantage/core'
import { buildWeekFocusCopy } from '@/lib/training/week-focus-copy'
import { FOCUS_EXERCISE_LABELS, focusExerciseIds, type WeeklyFocusArea } from '@dogvantage/core'
